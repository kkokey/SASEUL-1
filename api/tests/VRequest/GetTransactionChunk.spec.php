...
use src\VRequest\GetTransactionChunk;

describe('GetTransactionChunk', function () {
    given('getTransactionChunk', function () {
        return new GetTransactionChunk();
    });
    ...
    describe('getValidity', function () {
        ...
        given('requestType', function () {
            return GetTransactionChunk::TYPE;
        });
        ...
        given('subject', function () {
            $this->getTransactionChunk->initialize(
                $this->request,
            ...
            return $this->getTransactionChunk->getValidity();
        });
        ...
        context('with an invalid type', function () {
            given('requestType', function () {
                return '';
            });
        ...
        context('with a from address that banished', function () {
            beforeEach(function () {
                Tracker::Banish($this->account['address']);
            });
            ...
            afterEach(function () {
                Tracker::Admit($this->account['address']);
            });
        });
    });
});
